...
def h2_govde(b, i):
    ...
    if has("kısa", "uzun dönem", "aylık", "vadeli", "süreli"):
        return (f"<p>Kira aylık işliyor. {ek(i)} dış cephe boyası çoğu zaman birkaç haftada "
...
def ilce_h3_blok(i):
  ...
  <p>Mantolama, sıva yenileme ve güçlendirme işlerinde iskele aylarca duruyor. Uzun kirada
     iskeleyi düzenli kontrol ediyoruz — aylar süren şantiyede bu hem güvenlik hem denetim
     meselesi. Süre uzarsa aylık üzerinden devam ediyor, yeni bir kurulum ücreti çıkmıyor.</p>
...
<section class="bol"><div class="kap dar metin">
  ...
  <p>Kira cephe metrekaresi ve süre üzerinden; kurulum-söküm ise ayrı bir işçilik kalemi.
     Kendi ölçünüzü <a href="/#hesap">hesaplayıcıdan</a> kabaca çıkarabilirsiniz. Neyin fiyatı
     ne kadar değiştirdiğini <a href="/iskele-kiralama-fiyatlari/">fiyat rehberinde</a>
     kalem kalem yazdım.</p>
...
ANA_SSS = [
    ...
    ("İskele en az ne kadar süreyle kiralanıyor?",
     ...
     "aylara yayılıyor. Tavsiyem süreyi olduğundan kısa söylememeniz.. \"İki haftada biter\" "
     "deyip iki ay süren çok iş gördüm. Süre uzarsa aylık üzerinden devam ediyor."),
